...
class Modelorder: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(listorder, forKey: "listorder")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            listorder = unarchiver.decodeObject(forKey: "listorder") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/listorder.plist")
    }
}
