...
class OrdersModel: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(orderslist, forKey: "orderslist")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            orderslist = unarchiver.decodeObject(forKey: "orderslist") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/OrdersList.plist")
    }
}
