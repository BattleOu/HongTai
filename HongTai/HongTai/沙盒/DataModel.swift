...
class DataModel: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(userliebiao, forKey: "userliebiao")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            userliebiao = unarchiver.decodeObject(forKey: "userliebiao") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/userliebiao.plist")
    }
}
