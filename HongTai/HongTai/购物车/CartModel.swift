...
class CartModel: NSObject {
    ...
    func saveData() {
        ...
        archiver.encode(cartlist, forKey: "cartlist")
        //编码结束
    ...
    func loadData() {
        ...
        if defaultManager.fileExists(atPath: path) {
            ...
            cartlist = unarchiver.decodeObject(forKey: "cartlist") as! Array
            //结束解码
    ...
    func dataFilePath ()->String{
        return self.documentsDirectory().appendingFormat("/CartList.plist")
    }
}
