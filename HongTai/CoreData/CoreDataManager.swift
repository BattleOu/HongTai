...
class CoreDataManager: UIViewController {
  static let shared = CoreDataManager()
    ...
    // 增加数据
    func savePersonWith(userid: String, username: String, userpassword: String, userrelaname: String, birthday: String, userimage: String) {
    ...
    // 根据姓名修改数据
    func changePersonWith(userid: String, newusername: String, newuserpassword: String, newuserrelaname: String, newbirthday: String, newuserimage: String) {
        let fetchRequest: NSFetchRequest = User.fetchRequest()
        fetchRequest.predicate = NSPredicate(format: "userid == %@", userid)
        do {
            let result = try context.fetch(fetchRequest)
